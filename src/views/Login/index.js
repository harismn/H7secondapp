...
import { View, Text, Image, AsyncStorage, Button, StyleSheet } from 'react-native';
            ...
            <View style={styles.containerStyle}>
                ...
                <View style={styles.logoViewStyle}>
                    <Image 
                        ...
                        source={Foto.swipe3}
                    />
                    <Text style={styles.logoTextTitle}>7 Application</Text>
                    <Text style={styles.logoTextSubTitle}>Gratis</Text>
                </View>
